...
const data: Data = {
  ...
  summary: `フロントエンドエンジニアとして、主にVue.js, Nuxt.js, React, Next.jsを使用して開発を行っています。UI/UXデザインも行い、FigmaやXDを使用してデザインを作成しています。フロントエンドとデザインは親和性が高いと考えており、デザインを意識した開発を行っています。特に、ユーザーの視点に立ったデザインを心がけており、ステークホルダーの課題解決のお役に立てるように努めています。最近は、バックエンド技術にも興味を持ち、学習しています。`,
  ...
  projects: [
    {
      title: "建設会社向けのLPの作成",
      techStack: ["figma", "astro", "tailwindcss"],
      description:
        "建設会社向けの営業が難しい中で、営業の一環としてLPをデザインから実装まで一貫して作成",
    },
    {
